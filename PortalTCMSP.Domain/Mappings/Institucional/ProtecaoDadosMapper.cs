...
namespace PortalTCMSP.Domain.Mappings.Institucional
{
    ...
    public static class ProtecaoDadosMapper
    {
        public static CreateInstitucionalRequest ToInstitucionalCreate(this CreateProtecaoDadosRequest req)
        {
            ...
            foreach (var b in req.Blocos.OrderBy(x => x.Ordem))
            {
                ...
                {
                    Ordem = b.Ordem,
                    Html = b.Html,                 // se quiser, pode usar HTML no topo de cada seção
                    Titulo = b.Titulo,
                    Subtitulo = null,
                    Ativo = "S"
                };
        ...
        public static UpdateInstitucionalRequest ToInstitucionalUpdate(this UpdateProtecaoDadosRequest req)
        {
        ...
        public static ProtecaoDadosResponse ToProtecaoDadosResponse(this InstitucionalResponse r)
        {
            var resp = new ProtecaoDadosResponse
            {
                Id = r.Id,
                Slug = r.Slug,
                Titulo = r.Titulo,
            ...
            {
                resp.Blocos.Add(new ProtecaoDadosBlocoResponse
                {
                    Id = b.Id,
                    Ordem = b.Ordem,
                    Titulo = b.Titulo,
                    ...
                    Descricoes = b.Descricoes
                        .OrderBy(d => d.Ordem)
                        .Select(d => new ProtecaoDadosDescricaoResponse { Id = d.Id, Ordem = d.Ordem, Texto = d.Texto })
                        .ToList(),
                    Anexos = b.Anexos
                        .OrderBy(a => a.Ordem)
                        .Select(a => new ProtecaoDadosAnexoResponse { Id = a.Id, Ordem = a.Ordem, Link = a.Link })
                        .ToList()
                });
            }
        ...
        public static List<ProtecaoDadosResponse> ToProtecaoDadosResponse(this IEnumerable<InstitucionalResponse> list)
            => list.Select(ToProtecaoDadosResponse).ToList();
    }
}
