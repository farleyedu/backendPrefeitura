...
namespace PortalTCMSP.Domain.Mappings.Institucional
{
    ...
    public static class MissaoVisaoValoresMapper
    {
        // Create -> Institucional
        public static CreateInstitucionalRequest ToInstitucionalCreate(this CreateMissaoVisaoValoresRequest req)
        {
        ...
        public static UpdateInstitucionalRequest ToInstitucionalUpdate(this UpdateMissaoVisaoValoresRequest req)
        {
        ...
        public static MissaoVisaoValoresResponse ToMissaoVisaoValoresResponse(this InstitucionalResponse r)
        {
            var resp = new MissaoVisaoValoresResponse
            {
                Id = r.Id,
                Slug = r.Slug,
                Titulo = r.Titulo,
            ...
            {
                resp.Blocos.Add(new MissaoVisaoValoresBlocoResponse
                {
                    Id = b.Id,
                    Ordem = b.Ordem,
                    Titulo = b.Titulo,
                    Descricoes = b.Descricoes.OrderBy(d => d.Ordem)
                        .Select(d => new MissaoVisaoValoresDescricaoResponse { Id = d.Id, Ordem = d.Ordem, Texto = d.Texto }).ToList(),
        ...
        public static List<MissaoVisaoValoresResponse> ToMissaoVisaoValoresResponse(this IEnumerable<InstitucionalResponse> list)
            => list.Select(ToMissaoVisaoValoresResponse).ToList();
    }
}
