...
namespace PortalTCMSP.Api.Controllers.Institucional
{
    ...
    {
        private readonly ICompetenciasService _service;
        private readonly ILogger<CompetenciasController> _logger;

        public CompetenciasController(ICompetenciasService service, ILogger<CompetenciasController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateCompetenciasRequest request, CancellationToken ct)
        {
        ...
        [HttpPut("{id:long}")]
        public async Task<IActionResult> Update(long id, [FromBody] UpdateCompetenciasRequest request, CancellationToken ct)
        {
