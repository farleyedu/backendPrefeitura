...
namespace PortalTCMSP.Api.Controllers.Institucional
{
    ...
    public class RelatoriasController : ControllerBase
    {
        private readonly IRelatoriasService _service;
        private readonly ILogger<RelatoriasController> _logger;

        public RelatoriasController(IRelatoriasService service, ILogger<RelatoriasController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateRelatoriasRequest request, CancellationToken ct)
        {
        ...
        [HttpPut("{id:long}")]
        public async Task<IActionResult> Update(long id, [FromBody] UpdateRelatoriasRequest request, CancellationToken ct)
        {
        ...
        public async Task<IActionResult> HardDelete(long id, CancellationToken ct)
        {
