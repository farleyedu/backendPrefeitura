...
namespace PortalTCMSP.Api.Controllers.Institucional
{
    ...
    public class LegislacaoController : ControllerBase
    {
        private readonly ILegislacaoService _service;
        private readonly ILogger<LegislacaoController> _logger;

        public LegislacaoController(ILegislacaoService service, ILogger<LegislacaoController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateLegislacaoRequest request, CancellationToken ct)
        {
        ...
        [HttpPut("{id:long}")]
        public async Task<IActionResult> Update(long id, [FromBody] UpdateLegislacaoRequest request, CancellationToken ct)
        {
